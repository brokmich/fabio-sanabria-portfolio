...
export default function Projects() {
  ...
  const isActive = (i) =>
    spreadLeft > 0 &&
    spreadLeft < totalPages - 1 &&
    (i === spreadLeft - 1 || i === spreadLeft);

  return (
    <section
      className={`projects section${view === "book" ? " projects--dark" : ""}`}
      id="projects"
    >
          ...
          {view === "book" ? (
            ...
            >
              ...
              <p className="projects__hint">
                Click the arrows or drag the page edges to flip
              </p>
            </motion.div>
          ) : (
            <motion.div
